...
newarrcreator(name){
  ...
  this.workingArr = this.lists[this.lists.length-1].arr;
this.currentlist = this.lists.length-1;
 this.listName = this.lists[this.lists.length-1].number;
   console.log(this.listName, this.lists)
}
}
